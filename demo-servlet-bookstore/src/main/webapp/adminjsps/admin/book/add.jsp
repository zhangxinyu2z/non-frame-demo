...
<style type="text/css">
  ...
  <body>
    ...
    <form action="<c:url value='/AdminUploadServlet'/> " method="post" enctype="multipart/form-data">
    	图书名称：<input style="width: 150px; height: 20px;" type="text" name="bname"/><br/>
    	图书图片：<input style="width: 223px; height: 20px;" type="file" name="image"/><br/><!-- 文件上传表单项 -->
    	...
    	图书分类：<select style="width: 150px; height: 20px;" name="cid">
    		...
    		<option value="${ebookCategory.cid}">${ebookCategory.cname}</option>
			</c:forEach>
    	</select>
    	<br/>
