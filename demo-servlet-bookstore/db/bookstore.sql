...
INSERT  INTO ebookCategory(cid,cname) VALUES ('1','JavaSE');
INSERT  INTO ebookCategory(cid,cname) VALUES ('2','JavaEE');
INSERT  INTO ebookCategory(cid,cname) VALUES ('3','Javascript');

SELECT * FROM ebookCategory;
...
CREATE TABLE book (
  ...
  image VARCHAR(200),
  cid CHAR(32),
  FOREIGN KEY (cid) REFERENCES ebookCategory(cid)
);
